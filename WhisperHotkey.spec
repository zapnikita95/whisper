...
binaries = []
hiddenimports = ['whisper_hotkey_core', 'whisper_hotkey_tray', 'whisper_models', 'whisper_file_log', 'whisper_nvidia_path', 'speaker_verify', 'faster_whisper', 'whisper_version', 'keyboard', 'pyaudio', 'pyperclip', 'soundfile', 'numpy', 'plyer.platforms.win.notification', 'pystray', 'PIL', 'PIL.Image']
